...
describe 'gets total of trip' do
  ...
  it 'averages trail amounts' do
    ...
    expect(trip.average_distance).to eq(3.5)
  end

  it 'longest trail amounts' do
    name = 'Summer Swim'
    start = '2018-05-28 08:37:48'
    end_time = '2018-05-28 12:37:48'
    trail_name = 'Switchbacks'
  ...
  it 'shortest trail amounts' do
    ...
    expect(trip.shortest_distance).to eq(3)
  end
end
